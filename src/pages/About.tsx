...
export const About = () => {
  ...
  return (
    <div className='about container'>
        ...
        <div className='room--catalog__bottom room--catalog about__photos'>
            {homeCatalog.map((obj, index) => (
            <div className='room--catalog__bottom--card room--catalog__bottom--card about__photos--card' key={index}>
