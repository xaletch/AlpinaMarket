...
import { ButtonComeBack } from '../../ButtonComeBack/ButtonComeBack'

export const CartEmpty = () => {

  const handleClickReturnCatalog = () => {
    window.scrollTo(0, 0);
  };
