...
export const OrderSent = ( { setIsModalWindowTwo } ) => {
    ...
    return (
        <div className='product-info_modal-window' onClick={handleClickCloseOrderSent}>
            <div className='product-info_modal-window-sent' onClick={(e) => e.stopPropagation()}>
                ...
                <div className='product-info_modal-window-sent_svg'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none">
                        ...
                        <g mask="url(#mask0_11366_77721)">
                            <path fillRule="evenodd" clipRule="evenodd" d="M4 24V23.6C4.21986 12.6091 13.2692 3.85593 24.2613 4.00177C35.2535 4.14762 44.0674 13.1378 43.9956 24.1307C43.9237 35.1236 34.9931 43.9978 24 44C12.9593 43.9879 4.01212 35.0407 4 24ZM12 26L20 34L36 18L33.18 15.16L20 28.34L14.82 23.18L12 26Z" fill="#1C9407"/>
                        </g>
                    </svg>
                </div>
