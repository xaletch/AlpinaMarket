...
export const SearchMenu = ({ isSearchOpen, setIsSearchOpen, searchValue, setSearchValue, products, inputRef }) => {
  const [value, setValue] = useState('Белый стул')
    ...
    <>
      {isSearchOpen && (
        <div className='search__menu--content'>
          ...
          {searchValue && (
            <div className='search__menu--found--item'>
...
function useDebounce(value: any, arg1: number) {
